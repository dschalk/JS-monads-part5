...
var ret = (0, _motorcycleDom.h)('pre', '  var ret = function ret(v) {\n    var mon = new Monad(v, \'anonymous\');\n    return mon;\n  }  ');
...
function main(sources) {
  ...
  return {
    DOM: calcStream$.map(function () {
      return (0, _motorcycleDom.h)('div.content', [(0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('h2', 'JS-monads-part5 - Specialized Monads'), (0, _motorcycleDom.h)('p', ' In this installment of the JS-monads series, I continue to explore the utility of simple, little monads. In previous installments, I used instances of Monad in conjunction with instances of MonadIter to organize complex operations into small blocks of easy-to-maintain code. I showed how step-wise iteration and lazy evaluation can be accomplished without reliance on libraries or Javascript 2015 Promises or Iterators. In this installment of the series, I add a third monad constructor, Monad$, to the mix. Each instance emits a stream of the data it obtains with its "ret()" method. As we shall see, the code for traversing the history of the numbers display in the dice game becomes more efficient and easier to reason about with the help of an instance of Monad$. '), (0, _motorcycleDom.h)('span.tao', ' The monads are independent, but they are a good match for '), (0, _motorcycleDom.h)('a', { props: { href: 'https://github.com/motorcyclejs' } }, 'Motorcycle.js'), (0, _motorcycleDom.h)('span', ', which is Cycle.js, only using '), (0, _motorcycleDom.h)('a', { props: { href: 'https://github.com/paldepind/snabbdom' } }, 'Snabbdom'), (0, _motorcycleDom.h)('span', ' instead of "virtual-dom", and '), (0, _motorcycleDom.h)('a', { props: { href: 'https://github.com/cujojs/most' } }, 'Most'), (0, _motorcycleDom.h)('span', ' instead of "RxJS". I much prefer Cycle.js technology over React.js, which I used preveiously.    '), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('span.tao', 'This web page is an application that uses websockets. It sends and recieves websockets messages without regard for the type of server on the backend. The server happens to be a Haskell '), (0, _motorcycleDom.h)('a', { props: { href: 'https://github.com/yesodweb/wai/tree/master/wai-websockets' } }, 'Wai Websockets server'), (0, _motorcycleDom.h)('span', '. I like it because it is fast and reliable, and because the code is very easy to modify whenever the need arises due to list comprehension and pattern matching. You just tell Haskell what you want, kind of like talking to a robot, and you get it. When used as intended, Haskell won\'t surprise you with unintended side effects.  '), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('span.tao', 'The rules and the code for the '), (0, _motorcycleDom.h)('span', ' game used in this demonstration are discussed in earlier installments of this series, which can be found at  '), (0, _motorcycleDom.h)('a', { props: { href: 'http://schalk.net' } }, 'http://schalk.net'), (0, _motorcycleDom.h)('span', ' The code repository is at '), (0, _motorcycleDom.h)('a', { props: { href: 'https://github.com/dschalk/JS-monads-part5' } }, 'Code.'), (0, _motorcycleDom.h)('span', ' Here are the basic rules:'), (0, _motorcycleDom.h)('p', 'RULES: If clicking two numbers and an operator (in any order) results in 20 or 18, the score increases by 1 or 3, respectively. If the score becomes 0 mod 5, 5 points are added. A score of 25 results in one goal. That can only be achieved by arriving at a score of 20, which jumps the score to 25. Directly computing 25 results in a score of 30, and no goal. Each time ROLL is clicked, one point is deducted. Three goals wins the game. '), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('button#0.num'), (0, _motorcycleDom.h)('button#1.num'), (0, _motorcycleDom.h)('button#2.num'), (0, _motorcycleDom.h)('button#3.num'), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('button#4.op', 'add'), (0, _motorcycleDom.h)('button#5.op', 'subtract'), (0, _motorcycleDom.h)('button#5.op', 'mult'), (0, _motorcycleDom.h)('button#5.op', 'div'), (0, _motorcycleDom.h)('button#5.op', 'concat'), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('button.roll', { style: tempStyle2 }, 'ROLL'), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('button#back2', { style: tempStyle2 }, 'FORWARD'), (0, _motorcycleDom.h)('button#forward2', { style: tempStyle2 }, 'BACK'), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('div.winner', O.mMgoals2.x + ''), (0, _motorcycleDom.h)('p.login', { style: tempStyle }, 'Please enter some name.'), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('input.login', { style: tempStyle }), (0, _motorcycleDom.h)('p', O.mM6.x.toString()), (0, _motorcycleDom.h)('p.group', { style: tempStyle2 }, 'Change group: '), (0, _motorcycleDom.h)('input.group', { style: tempStyle2 }), (0, _motorcycleDom.h)('div.messages', [(0, _motorcycleDom.h)('p', { style: tempStyle2 }, 'Enter messages here: '), (0, _motorcycleDom.h)('input.inputMessage', { style: tempStyle2 }), (0, _motorcycleDom.h)('div', O.mMmsg.x)]), (0, _motorcycleDom.h)('p.group2', [(0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('span', 'Group: ' + O.mMgroup.x), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('span', 'Goals: ' + O.mMgoals.x), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('span', 'Name: ' + O.mMname.x), (0, _motorcycleDom.h)('br'), (0, _motorcycleDom.h)('div.scoreDisplay', [(0, _motorcycleDom.h)('span', 'player[score][goals]'), (0, _motorcycleDom.h)('div', O.mMscoreboard.x)])]), (0, _motorcycleDom.h)('span.tao', 'People in the same group, other than solo, share text messages and dice rolls. '), (0, _motorcycleDom.h)('hr'), (0, _motorcycleDom.h)('h2', 'Streams and Time Travel'), (0, _motorcycleDom.h)('span.tao', 'The monads presented in this series are simple and flexible. In their basic form, they are great for streamlining and organizing code. If you want error handling, enforcement of type rules, or something specific to your own application, you can modify the basic Monad constructor, give it a new name, and start spawning instances of your creation. Monad$ as a good example. It uses "subject" from the '), (0, _motorcycleDom.h)('a', { props: { href: "https://github.com/tylors/most-subject.git" } }, 'most-subject'), (0, _motorcycleDom.h)('span', ' library, and is defined as follow: '), _codeJs2['default'].Monad$, (0, _motorcycleDom.h)('p', 'The function "ret" is frequently used to create instances of Monad. Before we go any farther, I\'ll show the definition of "ret": '), _codeJs2['default'].ret, (0, _motorcycleDom.h)('p', 'There is also the Monad method ret(), and like the function ret(), it is used to create new instances of Monad and Monad$. The ret() method has been modified for this installment of the JS monads series and for the foreseeable future. As always, for any instance of Monad, say "m", m.ret(v) gives m the value v. In other words, m.ret(v) results in m.x === v. This result can be accomplished through mutation by setting m.x = v, but we don\'t do that. The m.ret(v) method creates a new Monad instance named "m" with value v. '), (0, _motorcycleDom.h)('p', 'In JS-monads-part4 the Monad instances created by the "ret()" method were in global scope. Like their originally created instances, they were attributes of window. In this, the fifth part of the series, I retain all of the benefits of a "no-mutations" policy and gain some advantage by attaching new monad instances created by "ret()" to the one and only object that I mutate, which I named "O". Instead of mutating window, I mutate O. '), (0, _motorcycleDom.h)('p', 'The originally created instances of Monad and Monad$ always retain their original values. All updates are in the O name space. An original instance, say m, can do its work unincumbered. The latest value obtained by m.ret() is O.m.x, which can use its ret() method to transform the value that it holds. I find the code easier to reason about when I can see which instances are workers and which instances contain mission critical information by simply observing the presence or absence of the "O." prefix. '), (0, _motorcycleDom.h)('p', 'The unique clones created by the ret() can be preserved, for example with variable references or adding them to arrays. That wasn\'t necessay in this demonstration, where the game number display is preserved in an array of arrays. '), (0, _motorcycleDom.h)('p', 'The ret() method is central to the functionality of Monad$ instances. mM$1, an instance of Monad$, guides the flow of game play, using mM$1.ret(some array) to push new dice rolls or freshly computed numbers into mM$1.stream. mM$1Action observes mM$1.stream, using the arrays it receives to update the number display, and to popule mMhistorymM1, a monad used for traversing the numbers display history. Here are the functions that handle the flow of information when a player clicks a number or an operator: '), _codeJs2['default'].nums, (0, _motorcycleDom.h)('p', ' mM$3 assists in the traversal of game display history. The data carried in mM$3.stream is of no consequence, so the argument provided to mM$3.ret() doesn\'t matter either. The value of mMindex2 changes when BACK or FORWARD are clicked, and that affects the browser display the next time the DOM is patched. mM$3.ret is called in order to trigger a DOM. Here is the code: '), _codeJs2['default'].travel, (0, _motorcycleDom.h)('p', ' cleanup() keeps "undefined" from cluttering the display. '), _codeJs2['default'].cleanup, (0, _motorcycleDom.h)('p', ' For history traversal, it is important to avoid mutating the underlying array when push, shift, and the other Javascript array methods are used. Here are some of the array functions that are provided to the Monad "bnd" method: '), _codeJs2['default'].arrayFuncs, (0, _motorcycleDom.h)('hr'), (0, _motorcycleDom.h)('h2', 'mM$1 In Action'), (0, _motorcycleDom.h)('p', 'The function responsible for updating scores is shown below. It gets called whenever two numbers and an operator have been selected, in any order.'), _codeJs2['default'].updateCalc, (0, _motorcycleDom.h)('p', ' Note the line: '), (0, _motorcycleDom.h)('pre', ' .bnd(() => O.mM$1.bnd(push, O.mM7.x, mM$1) '), (0, _motorcycleDom.h)('p', ' From the definition of "push", we see that the computed number in O.mM7 is pushed into the array which is held in O.mM$1, mM$1.ret() is called on the expanded array, and mM$1 is returned. From the definition of "ret" in Monad$, it is apparent that the expanded array that was the argument for mM$1.ret() gets pushed into mM$1.stream. That causes mM$1Action to add the array to O.mMhistorymM1.x and update the virtual DOM with the new numbers. '), (0, _motorcycleDom.h)('h2', 'Some More Code Analysis'), (0, _motorcycleDom.h)('p', 'Information cycles into the "main" function, the function that returns the virtual DOM description, carrying a single argument: "sources". sources.WS provides websockets messages to the messages stream, which parses and acts upon them as follows: '), _codeJs2['default'].messages, (0, _motorcycleDom.h)('p', 'When a message prefixed by "CA#$42" arrives from the server, the following code is executed: '), _codeJs2['default'].C42, (0, _motorcycleDom.h)('p', ' As always, mM$1.ret() is called on array. In this case, it is the new roll of the dice. mM$1.ret() causes mM$1.stream to push the information to mM$1Action which updates virtual DOM number display and adds the array to O.mMhistorymM1.x '), (0, _motorcycleDom.h)('hr'), (0, _motorcycleDom.h)('p', 'Here are the basic monad constructors: '), _codeJs2['default'].monads, (0, _motorcycleDom.h)('p', ' The message-handling code is shown above. This is how the websockets driver, the "WS" attribute of "sources", is defined: '), _codeJs2['default'].driver, (0, _motorcycleDom.h)('p', 'MonadIter instances have the "mMZ" prefix. Each instance has a "p" attribute which is a selector pointing to all of the code which comes after the call to its "bnd" method. Here is its definition of "next": '), _codeJs2['default'].next, (0, _motorcycleDom.h)('p', '"next" provides a simple but reliable way to assure that the messages$ stream and the updateCalc function respond appropriately to incoming data. The code using "next" is like a switch block, only more compact.  '), (0, _motorcycleDom.h)('span.tao', 'This is a link ot the Github repository: '), (0, _motorcycleDom.h)('a', { props: { href: 'https://github.com/dschalk/JS-monads-part5' } }, 'JS-monads-part5'), (0, _motorcycleDom.h)('p'), (0, _motorcycleDom.h)('hr'), (0, _motorcycleDom.h)('span.tao', 'The next installment in this series features a todo list that is shared within groups over websockets. It, along with prior installments, are available at '), (0, _motorcycleDom.h)('a', { props: { href: 'http://schalk.net' } }, 'schalk.net'), (0, _motorcycleDom.h)('p', ' . '), (0, _motorcycleDom.h)('p'), (0, _motorcycleDom.h)('p')]);
    })
  };
}
