...
var test = (0, _motorcycleDom.h)('pre', '  \n  ');
...
var updateMessages = function updateMessages(v) {
  ...
  var keys = Object.keys(ar);
  for (var k in keys) {
    mMmessages.bnd(unshift, (0, _motorcycleDom.h)('div', ar[k]), mMmessages);
  }
  return mMmessages;
};
